...
public interface RentalBookingRepository extends JpaRepository<RentalBooking, Long> {
    ...
    List<RentalBooking> findByVehicleOwnerId(@Param("ownerId") Long ownerId);
    ...
    boolean existsByVehicleIdAndStatus(Long vehicleId, RentalBooking.BookingStatus status);
}
